    ...
    <div class="row">
        <div class="col" >
            <div class="text-center">
                <a href="login.php">
                    <img src="../../public/img/logo.png" alt="logo" width="400" height="280" style="margin-top: 50px;" >
                </a>
            </div>
        </div>
                ...
                <div class="formulario">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                 ...
                                 <input  placeholder="Nombre de usuario" name="email" type="text" autofocus required>

                                 <input  placeholder="Contraseña" name="password" type="password" value="" required>
